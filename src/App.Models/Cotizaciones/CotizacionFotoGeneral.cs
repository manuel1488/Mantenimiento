...
/// <summary>Foto general de una Cotización, no asociada a ninguna línea (Servicio) en particular. El
/// archivo y su miniatura se guardan en MinIO vía <see cref="Core.Interfaces.IFileStorageService"/> —
/// aquí solo se persiste la clave del objeto y su metadata.</summary>
[Table("cot_cotizacion_fotos_generales")]
public class CotizacionFotoGeneral : BaseEntity<int>, IAuditTracked
{
    [Required]
